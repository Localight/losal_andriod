...
import co.localism.losal.activities.ActivateSocialActivity.ResponseListener;
...
//	private SessionStore mSessionStore;
	...
	public String TAG = "InstaImpl";
	
	public InstaImpl(Context context)
	{
		mContext = context;
//		mSessionStore = new SessionStore(context);
		mClient_id = context.getResources().getString(R.string.instagram_client_id); // Recommended: Put your Instagram ID in string class
		mClient_secret = context.getResources().getString(R.string.instagram_client_secret); // Recommended: Put your Instagram Secret in string class
		CALLBACKURL = context.getResources().getString(R.string.instagram_callback_url);
